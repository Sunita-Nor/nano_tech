   ...
   <div class="site-footer">
     <div class="container">
         ...
         <div class="row">
           <div class="col-12 col-md-6 col-lg-5">
             <div class="site-footer__widget footer-contacts">
               <h5 class="footer-contacts__title">ติดต่อสอบถาม</h5>
               <ul class="footer-contacts__contacts">
                 <li>
                   <i class="footer-contacts__icon fas fa-globe-americas"></i>
                   250 หมู่6 ตำบล สามควายเผือก เมืองนครปฐม นครปฐม 73000
                 </li>
                 <li><i class="footer-contacts__icon far fa-envelope"></i> nano22.tech@gmail.com</li>
                 <li><i class="footer-contacts__icon fas fa-mobile-alt"></i> (+66) 9833-02622, (+66) 9045-98725</li>
                 <li><i class="footer-contacts__icon far fa-clock"></i> วันจันทร์ - วันศุกร์ : 10:00 - 19:00</li>
               </ul>
             </div>
           </div>
           <div class="col-6 col-md-3 col-lg-2">
             <div class="site-footer__widget footer-links">
               <h5 class="footer-links__title">ช่องทางการชำระ</h5>
           ...
           <div class="col-6 col-md-3 col-lg-2">
             <div class="site-footer__widget footer-links">
               <h5 class="footer-links__title">จัดส่งสินค้าโดย</h5>
               <ul class="footer-links__list">
                 <li class="footer-links__item">
           ...
           <div class="col-12 col-md-12 col-lg-3">
             <div class="site-footer__widget footer-newsletter">
               <h5 class="footer-newsletter__title">ข่าวสาร</h5>
               <div class="footer-newsletter__text">ติดตามข่าวสารใหม่ๆ ของทางร้านผ่านช่องทาง</div>
               <ul class="footer-newsletter__social-links">
                 ...
                 <li class="footer-newsletter__social-link footer-newsletter__social-link--line">
                   <a href="https://themeforest.net/user/kos9" target="_blank"><i class="fab fa-line"></i></a>
                 </li>
               </ul>
             </div>
           </div>
       ...
       <!-- <div class="site-footer__bottom">
         <div class="site-footer__copyright"><a target="_blank" href="#"></a>
         </div>
 ...
 <!-- site / end -->
 <script src="../shop/js/navbar.js"></script>
 </body>
